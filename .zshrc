...
plugins=(zsh-lazyload git zsh-syntax-highlighting zsh-autosuggestions last-working-dir)
...
# pnpm
export PNPM_HOME="/home/brunicius/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
...
# lazyload clockify-cli -- 'source <(clockify-cli completion zsh)'
